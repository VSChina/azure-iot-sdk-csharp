...
namespace Microsoft.Azure.Devices.Client.Samples
{
    class Program
    {
        ...
        private const string DeviceConnectionString = "HostName=iot-sdks-test.azure-devices.net;DeviceId=useragent_csharp;SharedAccessKey=sRhQ3XEmP46o5qyuPFQN4b8JA5tLpp0gKu1KdFFz++Y=";
        private const string FilePath = "testing.txt";
